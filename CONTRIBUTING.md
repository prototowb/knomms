<!-- proto-gear:header
purpose: Contribution guidelines for human contributors
read-when: Before accepting outside contributions
priority: optional
defines:
  - contribution-flow
...
git checkout -b feature/KC-XXX-description

# For bug fixes
git checkout -b bugfix/KC-XXX-description
```
...
```bash
git push origin feature/KC-XXX-description
```
