...
**State:** v0.12.0 released — video transcript ingestion part 1; everything KC-032–095 verified (cloud enabled-path still pending an operator API key)  
**Branch:** `development` ahead of `main` — **PR #15 (open) now carries both v0.11.0 and v0.12.0**; tags v0.10.0/v0.11.0/v0.12.0 pushed  
**Tests:** 206/206 backend (pytest) · 0 TypeScript errors (vue-tsc)  
**Live verification:** through KC-070 via the 37-check three-user script (`scripts/verify-v070.sh`); v0.8.0 disabled-path + v0.9.0 study-KB + v0.10.0 cohort + v0.11.0 gates (`scripts/verify-v0110.py`) + v0.12.0 video (`scripts/verify-v0120.py`) green on Colima (2026-08-06). Migration head: **018** (v0.12.0 is schema-free).  
